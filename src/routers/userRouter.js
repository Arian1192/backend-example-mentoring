...
const {getAllUsers, getUserById, postUser, patchUser, deleteUser} = require('../controllers/userController'); // We import the methods from the userController.
...
userRouter.get('/:id', isUserOnDatabase, getUserById);
// post Methods
